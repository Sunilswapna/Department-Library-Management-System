...
if(isset($_POST['add']))
{
    ...
    $author = $_POST['author']; // ID of the selected author
    $aname = $_POST['aname']; // Author name from text field
    $isbn = $_POST['isbn'];
    $price = $_POST['price'];
    $copies = $_POST['copies'];

    // Insert the book information into the database
    $sql = "INSERT INTO tblbooks(BookName, CatId, AuthorId, AuthorsName, ISBNNumber, BookPrice, Copies) VALUES(:bookname, :category, :author, :aname, :isbn, :price, :copies)";
                        ...
                        <div class="panel-body">
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="aname" required="required" autocomplete="off" />
                                </div>
                                <div class="form-group">
