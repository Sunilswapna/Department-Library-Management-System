...
if(isset($_GET['del'])) {
    ...
    // Check if the book ID exists before trying to delete it
    $sql = "SELECT id FROM tblbooks WHERE id = :id";
    ...
    if($query->rowCount() > 0) {
        ...
        $_SESSION['delmsg'] = "Book not found";
    }
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr>
                                            <td colspan="6" class="center">No books issued</td>
                                        </tr>
                                    <?php 
                                    }
                                    ?>                                      
